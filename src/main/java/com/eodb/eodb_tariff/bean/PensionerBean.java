...
public void setLifeCertificate(String lifeCertificate) {
	this.lifeCertificate = lifeCertificate;
}
public String getReMarriage() {
	return reMarriage;
}
public void setReMarriage(String reMarriage) {
	this.reMarriage = reMarriage;
}
public String getReEmployed() {
	return reEmployed;
}
public void setReEmployed(String reEmployed) {
	this.reEmployed = reEmployed;
}
...
public String getPramaanId() {
	return pramaanId;
}
public void setPramaanId(String pramaanId) {
	this.pramaanId = pramaanId;
}
...
public String getPensionerTypeId() {
	return pensionerTypeId;
}
public void setPensionerTypeId(String pensionerTypeId) {
	this.pensionerTypeId = pensionerTypeId;
}
