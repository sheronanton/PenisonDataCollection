...
import com.eodb.eodb_tariff.bean.PensionerBean;
...
import com.eodb.eodb_tariff.service.PensionerDetailsService;
...
public class EmployeeDetailsController {
	...
	public List<Map<String, Object>> getEmployeeDetails(@RequestBody RequestBean bean) {
		
		String pensionerType  = (String) bean.getPensionerType();
		
		
		
		List<Map<String, Object>> pensionDetails =pensionerDetailsService.getEmployeeDetails(bean.getPaymentOfficeId(), pensionerType);
	...
	public ResponseEntity<ResponseBean> savePensionerDetails(@RequestBody RequestBean requestBean){
		...
		PensionerDetailsEntity pensionerDetailsEntity = requestBean.getPensionerDetailsEntity();
